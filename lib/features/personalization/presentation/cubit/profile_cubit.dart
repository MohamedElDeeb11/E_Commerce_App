...
class ProfileCubit extends Cubit<ProfileState> {
  ...
  Future<void> getProfile() async {
    ...
    // لو حصل خطأ (مثلاً Session لسه بتحمل)، نصبر نصف ثانية ونحاول تاني تلقائياً
    if (result.isLeft()) {
    ...
    result.fold(
      (error) {
        print('PROFILE ERROR: $error'); // طباعة الخطأ الحقيقي في الـ Debug Console لمعرفته فوراً
